          ...
          <div className="p-6 overflow-y-auto space-y-6">
            ...
            <div className="p-5 border border-gray-100 rounded-2xl bg-gray-50/50 space-y-4">
              <h4 className="text-xs font-black text-gray-400 uppercase tracking-widest flex items-center gap-2">
                <i className="fas fa-vial text-[10px]" /> Agregar Insumos
              </h4>
              <div className="grid grid-cols-12 gap-3 items-end">
                ...
                <div className="col-span-6 md:col-span-2">
                  <button
                    type="button"
                    className="w-full inline-flex items-center justify-center gap-2 px-4 py-2 bg-agro-primary text-white text-sm font-bold rounded-xl shadow shadow-agro-primary/20 hover:bg-agro-secondary transition-all active:scale-95 disabled:opacity-50"
                    onClick={addLine}
